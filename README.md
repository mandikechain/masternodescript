...
4. Send 30000 XMD to this address and wait for at least 1 confirmation
...
```
bash <( curl -sL https://raw.githubusercontent.com/mandikechain/masternodescript/main/install.sh)
```
...
```<alias> <ip>:11965 <private_key> <tx_id> <index>```
3. It should look something like this:
``` MN1 127.0.0.2:11965 XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX X```
...
3. Enter ```mandike-cli getmasternodestatus```
4. This will tell you the status of your masternode, any questions, Join discord for help: https://discord.gg/uYzDSz5ZMb
